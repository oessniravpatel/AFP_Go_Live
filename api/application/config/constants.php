...
//define('BASE_URL', 'http://afp.devbyopeneyes.com'); // Development Base URL
...
define('ACTIVE_GROUP', 'postproduction'); // database mode
define('BASE_URL', 'http://afp.postprodbyopeneyes.com'); // postproduction Base URL
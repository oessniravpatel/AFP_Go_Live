...
class Register_model extends CI_Model
{
	...
	{	
		...
		{	
			...
			if(isset($post_user['Sales_Assign']) && !empty($post_user['Sales_Assign'])){
				$Sales_Assign = $post_user['Sales_Assign'];
			}	else {
				$Sales_Assign = '';
			}
	...
	public function get_userdata($user_id=Null)
	{
	  if($user_id)
	  {
		  ...
		  $this->db->select('us.UserId,us.CompanyId,us.FirstName,us.LastName,us.Title,us.EmailAddress,us.CountryId,us.StateId,us.City,us.ZipCode,us.PhoneNumber,us.PhoneNumberl,us.IsActive,
